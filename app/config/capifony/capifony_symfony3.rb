  ...
  module Symfony3
    def self.load_into(configuration)
      configuration.load do
        ...
        load 'capifony'
        load 'symfony3/symfony'
        load 'symfony3/database'
        load 'symfony3/deploy'
        load 'symfony3/doctrine'
        load 'symfony3/propel'
        load 'symfony3/web'
        load 'symfony3/shared'
...
if Capistrano::Configuration.instance
  Capifony::Symfony3.load_into(Capistrano::Configuration.instance)
end
